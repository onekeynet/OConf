...
import org.onosproject.store.service.exception.IllegalDocumentModificationException;
import org.onosproject.store.service.exception.NoSuchDocumentPathException;
 ...
 * Note: This class is based on ONOS patch#21890 created by Jordan Halterman.
 *
...
public class DefaultDocumentTree<V> implements DocumentTree<V> {
    ...
    public DefaultDocumentTree() {
        ...
        root = new DefaultDocumentTreeNode<>(DocumentPath.ROOT, null, versionSupplier.get(), Ordering.NATURAL, null);
    }

    public DefaultDocumentTree(Supplier<Long> versionSupplier, Ordering ordering) {
        root = new DefaultDocumentTreeNode<>(DocumentPath.ROOT, null, versionSupplier.get(), ordering, null);
