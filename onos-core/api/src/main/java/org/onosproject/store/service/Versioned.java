...
import org.onosproject.utils.ByteArraySizeHashPrinter;

import static org.onosproject.utils.Tools.defaultOffsetDataTime;
...
public class Versioned<V> {
    ...
    public String toString() {
        return MoreObjects.toStringHelper(this)
                ...
                .add("version", version)
                .add("creationTime", defaultOffsetDataTime(creationTime))
                .toString();
    }
}
